...
<div class="container-fluid" id="main-content">
    <div class="row">
        <div class="col-lg-10 ms-auto p4 overflow-hidden">
            <br>
            <h1 class="mb-4">USER BOOKING LIST</h1>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <table class="table table-hover border">
                    ...
                    <?php
                        ...
                        $in = mysqli_real_escape_string($con, $_POST['room']);
                        $q = "SELECT sr_no, name, room, bookdate, starttime, endtime, booktype, total_student, note, status
                            FROM booking 
                            WHERE room = '$in' 
                            ORDER BY bookdate ASC, starttime ASC, endtime ASC";
                    	...
                    	while($row=@mysqli_fetch_array($result, MYSQLI_ASSOC))

                                {
                                    ...
                                    <td>'.$row['note'].'</td>
                                    <td>'.$row['status'].'</td>
                                    <td align = "center"><a class="btn" href = "bookingUpdate.php?id='.$row['sr_no'].'">Update✍🏻</a></td>
                                    <td align = "center"><a class="btn" href = "bookingDelete.php?id='.$row['sr_no'].'">Delete🗑️</a></td>
                                    </tr>';
                                }
                ...
                <a class="btn" href = "bookingList.php?id='.$row['sr_no'].'">Back</a></td>
